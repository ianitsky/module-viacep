...
namespace Ianitsky\ViaCep\Ui\Component\Listing\Column;

class PostcodeActions extends \Magento\Ui\Component\Listing\Columns\Column
{

    const URL_PATH_EDIT = 'ianitsky_viacep/postcode/edit';
    const URL_PATH_DELETE = 'ianitsky_viacep/postcode/delete';
    protected $urlBuilder;
    const URL_PATH_DETAILS = 'ianitsky_viacep/postcode/details';
